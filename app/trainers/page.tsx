...
const globalStyles = `
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
  ...
  .page-hero-bg{position:absolute;inset:0;background:url('https://images.unsplash.com/photo-1517838277536-f5f99be501cd?w=1800&q=80') center/cover no-repeat;opacity:.55;}
  ...
  return (
    <section id="page-hero">
      ...
      <div className="page-hero-content">
        ...
        <h1 className="reveal" style={{ transitionDelay: "0.1s" }}>OUR<br />TEAM</h1>
        <div className="breadcrumb reveal" style={{ transitionDelay: "0.2s" }}>
          <a href="/">Home</a><span>/</span><span style={{ color: "#fff" }}>Team</span>
        </div>
      </div>
    </section>
  );
